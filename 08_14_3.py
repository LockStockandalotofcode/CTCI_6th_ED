def count_eval(expression: str, result: bool) -> int:
    return count_eval_helper(expression, result, {})
def count_eval_helper(expression: str, result: bool, memo:dict) -> int:
    ...
    while i < len(expression):
        ...
        left_t = count_eval_helper(left_exp, True, memo)
        left_f = count_eval_helper(left_exp, False, memo)
        right_t = count_eval_helper(right_exp, True, memo)
        right_f = count_eval_helper(right_exp, False, memo)
