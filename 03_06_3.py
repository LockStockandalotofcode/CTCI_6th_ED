...
class AnimalShelter:
    def __init__(self):
        self.dog_dummy_head = ListNode(data="Dog Dummy", serial_no=0)
        self.dog_tail = self.dog_dummy_head

        self.cat_dummy_head = ListNode(data="Cat Dummy", serial_no=0)
    ...
    def _enqueue_dog(self, animal_data: str) -> None:
        ...
        new_dog = ListNode(data=animal_data, serial_no=new_dog_sr_no)
    ...
    def _enqueue_cat(self, animal_data: str) -> None:
        ...
        # then create a dog node and append it to the linked list with the correct serial no
        new_cat = ListNode(data=animal_data, serial_no=new_cat_sr_no)
        self.cat_tail.next = new_cat
        self.cat_tail = self.cat_tail.next
        self.last_sr_no += 1
        return

    def dequeueAny(self) -> ListNode | ListNode | None:
    ...
    def dequeueDog(self) -> ListNode | None:
    ...
    def dequeueCat(self) -> ListNode | None:
        # edge case 1: no dog in the shelter 
